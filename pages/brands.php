...
<main class="container my-5">
    ...
    <div class="brands-hero text-center mb-5">
        <h1 class="fw-bold display-5">Featured Brands</h1>
        <p class="text-muted mb-0">Explore our exclusive collections from top international fashion brands.</p>
    </div>
                ...
                <div class="brand-card">
                    <div>
                        <div class="brand-logo-preview">
                            <span style="<?= $brand['font_style'] ?>">
                                <?= htmlspecialchars(strtoupper($brand['name']), ENT_QUOTES, 'UTF-8') ?>
                            </span>
                        </div>
                        
                        <span class="brand-tag d-block mb-2"><?= htmlspecialchars($brand['tag'], ENT_QUOTES, 'UTF-8') ?></span>
                        <h3 class="fw-bold fs-4 mb-2"><?= htmlspecialchars($brand['name'], ENT_QUOTES, 'UTF-8') ?></h3>
                        <p class="text-muted fs-6 mb-4"><?= htmlspecialchars($brand['desc'], ENT_QUOTES, 'UTF-8') ?></p>
                    </div>

                    <div class="pt-3 border-top">
                        <a href="<?= $siteRoot ?>/pages/products.php?brand=<?= urlencode($brand['name']) ?>" class="btn btn-outline-dark btn-explore w-100">
